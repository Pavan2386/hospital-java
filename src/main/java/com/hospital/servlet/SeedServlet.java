...
public class SeedServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		{"Meera Rao", "meera@hospital.com", "Gynecology", "MBBS, MD (Gynecology)", 12, "9876500021",
 "Specialist in pregnancy care, PCOS, and women’s health.", "900", "4.7"},

		{"Arun Varma", "arun@hospital.com", "ENT", "MBBS, MS (ENT)", 8, "9876500022",
 "Expert in ear infections, sinus issues, and throat disorders.", "600", "4.5"},
            };
